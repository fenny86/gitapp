...
public class insertClass {
	...
	String sqls = "insert into ClassTables"
			+ "(classId,className,classTeacher,classPrice,discount,classPicture,classCategory)"+ "VALUES (?,?,?,?,?,?,?)";

	try {		
		int result= queryRunner.update(sqls,classbean.getClassId(),classbean.getClassName(),classbean.getClassTeacher(),classbean.getClassPrice(),classbean.getDiscount(),classbean.getClassPicture(),classbean.getClassCategory());
