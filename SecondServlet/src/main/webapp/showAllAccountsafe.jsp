...
<!--                     <td><a class="fa-regular fa-trash-can" href=${request.getContextPath()}removeAccountControllersafe?id=${bean.id}>刪除</a></td> -->
                    <td>
                    	<a class="fa-solid fa-screwdriver-wrench"
                            href=${request.getContextPath()}showAccountControllersafe?id=${bean.id}>修改</a> &nbsp
                        <a class="fa-solid fa-trash-can"
                            href=${request.getContextPath()}removeAccountControllersafe?id=${bean.id}>刪除</a>
                    </td>
                     </tr>
            </c:forEach>
        </tbody>
