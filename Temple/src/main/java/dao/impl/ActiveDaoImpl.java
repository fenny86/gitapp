...
public class ActiveDaoImpl implements ActiveDao{
	...
	public int update(Active active) {
		...
		try {
			int result= queryRunner.update(ConnectionSMMS.createConnection(),sql,active.getActiveName(),active.getActiveImg(),active.getActiveDescription(),active.getActiveStartDate(),active.getActiveEndDate(),active.getActiveLocation(),active.getActiveHost(),active.getActiveID());
			return result;
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public int insert(Active active) {
		String sql="insert into templeActive values(?,?,?,?,?,?,?)";
		try {
			 int result= queryRunner.update(ConnectionSMMS.createConnection(),sql,active.getActiveName(),active.getActiveImg(),active.getActiveDescription(),active.getActiveStartDate(),active.getActiveEndDate(),active.getActiveLocation(),active.getActiveHost());
		return result;
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
